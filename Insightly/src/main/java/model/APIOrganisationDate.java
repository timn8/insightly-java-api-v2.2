...
public class APIOrganisationDate   {
   ...
   **/
  @ApiModelProperty(value = "Unique ID for the Organisation Date record")
   ...
   **/
  @ApiModelProperty(value = "Occasion Name of the Organisation Date")
   ...
   **/
  @ApiModelProperty(value = "Occasion date, in YYYY-MM-DD HH:MM:SS format")
